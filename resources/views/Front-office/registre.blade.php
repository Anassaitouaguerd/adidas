...
<body>
	...
	<!-- Start Header Area -->
	@include('partials.front-office._header')
	...
	<section class="login_box_area section_gap">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
						<div class="hover">
							<a class="primary-btn" href="/login">Have already an Account</a>
						</div>
				</div>
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="register" method="POST" id="contactForm">
							...
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="username" name="name" placeholder="Username" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'" required>
							</div>
							@error('name')

        ...
        <section class="login_box_area section_gap">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="hover">
                            <a class="primary-btn" href="/registre">Create an Account</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="login_form_inner">
                            ...
                            @endif
                            <form class="row login_form" action="forgotPassword" method="POST" id="contactForm">
                                @csrf
                                ...
                                <div class="col-md-12 form-group">
                                    <button type="submit" value="submit" class="primary-btn">Forgot Password</button>
                                </div>
                            </form>
                        </div>
                    </div>
